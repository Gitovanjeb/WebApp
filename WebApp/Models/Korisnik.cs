...
namespace WebApp.Models
{
    public abstract class Korisnik
    {
        ...
        {
            return $"{KorisnickoIme},{Lozinka},{Ime},{Prezime},{Pol},{Email},{DatumRodjenja}";
        }
        ...
        public static Korisnik Parse(string korisnikString)
        {
            ...
            {
                throw new ArgumentException("Invalid format for korisnikString. Expected 7 properties separated by commas.");
            }
